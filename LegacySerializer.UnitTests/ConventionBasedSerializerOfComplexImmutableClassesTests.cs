...
namespace Grean.AtomEventStore.LegacySerializer.UnitTests
{
    public class ConventionBasedSerializerOfComplexImmutableClassesTests
    {
            ...
            TestEventX tex)
        {
            ...
            using (var w = XmlWriter.Create(sb))
            {
                ...
                var expected = XDocument.Parse(
                    ...
                    "  <test-event-x xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests\">" +
            ...
            Envelope<TestEventX> env)
        {
            ...
            var expected = XDocument.Parse(
                "<content type=\"application/xml\" xmlns=\"http://www.w3.org/2005/Atom\">" +
                "  <envelope xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests\">" +
            ...
            TestEventU teu)
        {
            ...
            var expected = XDocument.Parse(
                "<content type=\"application/xml\" xmlns=\"http://www.w3.org/2005/Atom\">" +
                "  <test-event-u xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests\">" +
            ...
            SubNs.SubSubNs.TestEventS tes)
        {
            ...
            var expected = XDocument.Parse(
                "<content type=\"application/xml\" xmlns=\"http://www.w3.org/2005/Atom\">" +
                "  <test-event-s xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests:sub-ns:sub-sub-ns\">" +
            ...
            TestEventY tey)
        {
            ...
            var expected = XDocument.Parse(
                "<content type=\"application/xml\" xmlns=\"http://www.w3.org/2005/Atom\">" +
                "  <changeset xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests\">" +
                "    <id>urn:uuid:" + id + "</id>" +
                "    <test-event-x>" +
                "      <number>" + tex.Number + "</number>" +
                "      <text>" + tex.Text + "</text>" +
            ...
            TestEventD ted)
        {
            ...
            var expected = XDocument.Parse(
                "<content type=\"application/xml\" xmlns=\"http://www.w3.org/2005/Atom\">" +
                "  <test-event-d xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests\">" +
            ...
            TestEventSealed tes)
        {
            ...
            var expected = XDocument.Parse(
                "<content type=\"application/xml\" xmlns=\"http://www.w3.org/2005/Atom\">" +
                "  <test-event-sealed xmlns=\"urn:grean:atom-event-store:legacy-serializer:unit-tests\">" +
                "    <number>" + tes.Number + "</number>" +
                "    <text>" + tes.Text + "</text>" +
                "  </test-event-sealed>" +
                "</content>");
